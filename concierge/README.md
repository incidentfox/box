...
|---|---|
| [`00-install-this.md`](00-install-this.md) | **The all-in-one prompt** — does the whole setup end to end (pick a host, provision if needed, clone, install, hand you the URL and private token-retrieval instructions). Start here if you have nothing yet. |
